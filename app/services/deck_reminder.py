...
class DeckReminder:
    ...
    def remind_card_due_dates(self) -> None:
        """
        Fetch all boards from Nextcloud Deck via the API and remind about the
        due dates of cards.
        """
        events: dict[str, Any] = get_state(self.cards_processed_key, {"cards": {}})
        ...
        set_state(self.cards_processed_key, events)
